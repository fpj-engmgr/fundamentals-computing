...
print "Searched for 125", "Computed:", iter_binary_search(sorted_list, 0, len(sorted_list), 125), "Expected: False"
print               
print "Searched for 135", "Computed:", rec1_binary_search(sorted_list, 135), "Expected: True"
print "Searched for 125", "Compuued:", rec1_binary_search(sorted_list, 125), "Expected: False"
print
print "Searched for 135", "Computed:", rec2_binary_search(sorted_list, 0, len(sorted_list), 135), "Expected: True"
print "Searched for 125", "Computed:", rec2_binary_search(sorted_list, 0, len(sorted_list), 125), "Expected: False"
