...
wildfire = WildFire(30, 40)
wildfire.enqueue_boundary(15, 20)
print wildfire.boundary_size()
width = wildfire.get_grid_width() * CELL_SIZE
height = wildfire.get_grid_height() * CELL_SIZE
print width, height
frame = simplegui.create_frame("Smokey the Bear", width, height)
