...
class Bubble:
    ...
    def collide(self, bubble):
        if dist(self.pos, bubble.pos) < (2.0 * BUBBLE_RADIUS):
            return True
        return False
...
# create initial bubble, an empty set of stuck bubbles and start frame
a_bubble = Bubble(firing_sound)
stuck_bubbles = set()
